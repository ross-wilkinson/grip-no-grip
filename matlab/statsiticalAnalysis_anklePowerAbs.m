...
for iSub = 1:10
    t1 = mean(S.(measure1).(subjectList{iSub}).c0101);  
    t2 = mean(S.(measure1).(subjectList{iSub}).c0102);
    t3 = mean(S.(measure1).(subjectList{iSub}).c0103);
    t4 = mean(S.(measure1).(subjectList{iSub}).c0201);  
    t5 = mean(S.(measure1).(subjectList{iSub}).c0202);
    try
        t6 = mean(S.(measure1).(subjectList{iSub}).c0203);
    catch
        t6 = NaN;
    end
    t7 = mean(S.(measure1).(subjectList{iSub}).c0301);  
    t8 = mean(S.(measure1).(subjectList{iSub}).c0302);
    try
        t9 = mean(S.(measure1).(subjectList{iSub}).c0303);
    catch
        t9 = NaN;
    end
    t10 = mean(S.(measure1).(subjectList{iSub}).c0401);  
    t11 = mean(S.(measure1).(subjectList{iSub}).c0402);
    t12 = mean(S.(measure1).(subjectList{iSub}).c0403);

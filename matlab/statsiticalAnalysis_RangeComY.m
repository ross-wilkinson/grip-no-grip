...
measure = 'comPosY';
yLabel = 'Range of vertical CoM displacement (mm)';
yLim = [0 100];

for iSub = 1:10
    t1 = range(S.(measure).(subjectList{iSub}).c0101);  
    t2 = range(S.(measure).(subjectList{iSub}).c0102);
    t3 = range(S.(measure).(subjectList{iSub}).c0103);
    t4 = range(S.(measure).(subjectList{iSub}).c0201);  
    t5 = range(S.(measure).(subjectList{iSub}).c0202);
    try
        t6 = range(S.(measure).(subjectList{iSub}).c0203);
    catch
        t6 = NaN;
    end
    t7 = range(S.(measure).(subjectList{iSub}).c0301);  
    t8 = range(S.(measure).(subjectList{iSub}).c0302);
    try
        t9 = range(S.(measure).(subjectList{iSub}).c0303);
    catch
        t9 = NaN;
    end
    t10 = range(S.(measure).(subjectList{iSub}).c0401);  
    t11 = range(S.(measure).(subjectList{iSub}).c0402);
    t12 = range(S.(measure).(subjectList{iSub}).c0403);

...
% Conditions:
% 1. Seated, Grip (1,1)
% 2. Seated, No Grip (1,2)
% 3. Standing, Grip (2,1)
% 4. Standing, No Grip (2,2)
...
df = array2table(df, 'VariableNames', {'Subject','Posture','Grip','MaxPowerCycle'});
